<center>
    ...
    <h6><i>Les réservations nécessitent un compte client</i></h6>
</center>
...
<?php
    ...
    foreach ($periodes as $periode) {
        echo '<option value="' . $periode->DATEDEBUT . '">' . $periode->DATEDEBUT . '</option>';
    }
    echo '</select>';
                    ...
                    if (!empty($tableauTraversees)) {
                        ...
                        foreach ($tableauTraversees as $traversee) {
                            ...
                            if (!is_null($session->get('Identifiant'))) {
                                echo "<td>" . anchor('/reserver/' . $traversee['numero'], $traversee['numero'], "class=btn btn-outline-info") . "</td>";
                            } else {
                                echo "<td>" . $traversee['numero'] . "</td>";
                            }
